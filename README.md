...
**7 个视口 × 34 项 = 238 项，全部一致，0 处差异：**

| 视口 | 结果 | 页高 |
| --- | --- | --- |
| 320×568（iPhone SE1） | 34/34 ✓ | 1114.2 |
| 360×640 | 34/34 ✓ | 1046.2 |
| 375×812（iPhone X） | 34/34 ✓ | 1047.6 |
| 390×844 | 34/34 ✓ | 1048.9 |
| 414×896（11 Pro Max） | 34/34 ✓ | 1051.1 |
| 699×900 | 34/34 ✓ | 1059.6 |
| 700×900 | 34/34 ✓ | 1097.6 |
| 1440×1000（桌面） | 34/34 ✓ | 1097.6 |

320 和 700 这两个宽度是特意选的 —— 它们分别踩中 CSS 里的两个媒体查询
（`max-width:380px` 和 `min-width:700px`），**不验这两个就等于没验断点**。
撕口在 320 下应该是 `top:211px`、390 下应该是 `218px`，实测两边都对得上。
